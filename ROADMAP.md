...
| Order-flow data boundary documented | ✅ | Pine cannot access footprint, signed delta, or true Volume Profile POC. These stay discretionary or require Sierra Chart / Bookmap / Databento MBO + Python. |
